...
namespace UploadImage.Controllers
{
    public class ImageModelsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ImageId,Title,ImageIname")] ImageModel imageModel)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            var imagePath = Path.Combine(_hostEnvironment.WebRootPath, "image", imageModel.ImageIname);
